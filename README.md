...
jobs:
  zizmor:
    uses: vechain/github-actions-public/.github/workflows/scan-workflows.yaml@077c1b27d79d1afe348dee386370bc56b9c54924
    secrets:
      ZIZMOR_TOKEN: ${{ secrets.GITHUB_TOKEN }}
      
  actionlint:
    uses: vechain/github-actions-public/.github/workflows/action-lint.yaml@077c1b27d79d1afe348dee386370bc56b9c54924
```
...
```yaml
slither:
  uses: vechain/github-actions-public/.github/workflows/slither.yaml@v.0.1.0
```
...
```yaml
zizmor:
  uses: vechain/github-actions-public/.github/workflows/scan-workflows.yaml@v.0.1.0
  secrets:
    ZIZMOR_TOKEN: ${{ secrets.GITHUB_TOKEN }}
```
...
```yaml
actionlint:
  uses: vechain/github-actions-public/.github/workflows/action-lint.yaml@v.0.1.0
```
...
jobs:
  update-docs:
    uses: vechain/github-actions-public/.github/workflows/doc-update.yaml@v.0.1.0
```
