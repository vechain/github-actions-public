...
jobs:
  ...
  zizmor:
    uses: vechain/github-actions-public/.github/workflows/scan-workflows.yaml@main
    secrets:
      ZIZMOR_TOKEN: ${{ secrets.GITHUB_TOKEN }}
      
  actionlint:
    uses: vechain/github-actions-public/.github/workflows/action-lint.yaml@main
```
...
```yaml
slither:
  uses: vechain/github-actions-public/.github/workflows/slither.yaml@v1.0.0
```
...
```yaml
zizmor:
  uses: vechain/github-actions-public/.github/workflows/scan-workflows.yaml@v1.0.0
  secrets:
    ZIZMOR_TOKEN: ${{ secrets.GITHUB_TOKEN }}
```
...
```yaml
actionlint:
  uses: vechain/github-actions-public/.github/workflows/action-lint.yaml@v1.0.0
```
...
jobs:
  update-docs:
    uses: vechain/github-actions-public/.github/workflows/doc-update.yaml@v1.0.0
```
